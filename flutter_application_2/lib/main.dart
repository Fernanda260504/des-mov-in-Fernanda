...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  String name ="asdfasd";
  List<String> lista=["Eliel","Davd","Andres","Sofia"];
  Student student =Student(name: "Fernanda", enrollment:"20223TN086");
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: SizedBox(
             // height: 16,
              child: ElevatedButton(onPressed: addStudent, child:Text("Add Student")),
            ),
